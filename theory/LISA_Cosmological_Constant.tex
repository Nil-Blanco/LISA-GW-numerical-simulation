...
\author{Author: Nil Blanco Lausín, nblancla9@alumnes.ub.edu}
\affiliation{Facultat de F\'{\i}sica, Universitat de Barcelona, Diagonal 645, 08028 Barcelona, Spain.}

\author{Advisor: Domènec Espriu Climent, espriu@icc.ub.edu} 
...
\begin{center}
    ...
    Author:   Nil Blanco Lausín, nblancla9@alumnes.ub.edu \\
    \textit{Facultat de Física, Universitat de Barcelona, Diagonal 645, 08028 Barcelona, Spain.}
    
    \vspace{0.2cm}
    Advisor: Domènec Espriu Climent, espriu@icc.ub.edu
\end{center}
